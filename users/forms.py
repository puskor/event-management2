...
class Custom_pass_change_form(StyledFormMixin,PasswordChangeForm):
    pass

class Custom_pass_reset_form(StyledFormMixin,PasswordResetForm):
    pass

class Custom_pass_reset_confirm_form(StyledFormMixin,SetPasswordForm):
    pass
