...
from users.views import sign_up,sign_in,sign_out,activate_user,admin_dashboard,assign_roll,create_group,group_list,Profile_view,Password_change,Password_change_done,Password_reset,Password_reset_confirm
